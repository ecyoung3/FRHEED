...
path = 'D:/ElliotYoung/Desktop/FRHEED/Default/'
filename = 'default'
...
class FRHEED(QtWidgets.QMainWindow, form_class):
    ...
    def update_frame(self):
        global avg1, avg2, avg3, t0, t, p, x1, y1, x2, y2, a1, b1, a2, b2, c1, d1, c2, d2, samplenum, grower
        if not q.empty():
...
#### - Image annotation: crystal orientation, position in growth