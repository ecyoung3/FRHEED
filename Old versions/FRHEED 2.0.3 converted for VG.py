...
vidnum = 1
background = []
exposure = float(100000)# value in microseconds; use this for GigE camera
#exposure = -5 # use this for webcams
avg = 0
t0 = time.time()
...
#### Set properties if connected camera is a USB webcam ####
...
#        cam.ExposureTime.SetValue(int(self.lowexposuretime))
    ...
    def update_frame(self):
        global avg1, avg2, avg3, t0, t, p, x1, y1, x2, y2, a1, b1, a2, b2, c1, d1, c2, d2, movingshapes, basecoords, inverted, tstart, samplenum, grower, sampletextset, cmap, background, backgroundset, scaled_w, scaled_h, runstopwatch, timing, timer_active, stopwatch_active
