...
#### Config options ####
basepath = config['Elliot Desktop']['path']
...
class FRHEED(QtWidgets.QMainWindow, form_class):
    ...
    def __init__(self, parent=None):
        ...
        self.highexposuretime = int(config['Elliot Desktop']['highexposure'])
        self.lowexposuretime = int(config['Elliot Desktop']['lowexposure'])
...
#        cam.ExposureTime.SetValue(exposure)
    ...
    def highexposure(self):
        ...
        config['Elliot Desktop']['highexposure'] = val
        self.highexposuretime = config['Elliot Desktop']['highexposure']
#        cam.ExposureTime.SetValue(int(self.highexposuretime))
    ...
    def lowexposure(self):
        ...
        config['Elliot Desktop']['lowexposure'] = val
        self.lowexposuretime = config['Elliot Desktop']['lowexposure']
...
#            img = np.flipud(img)
    ...
    def mouseMoveEvent(self, event):
        global x1, y1, x2, y2, a1, b1, a2, b2, c1, d1, c2, d2, red, green, blue
        if self.drawCanvas.underMouse() and QtCore.Qt.LeftButton:
            if red:
...
camera_width = int(config['Elliot Desktop']['width'])
camera_height = int(config['Elliot Desktop']['height'])
fps = int(config['Elliot Desktop']['fps'])
